...
namespace NRules.RuleModel.Builders
{
    ...
    public class RuleBuilder
    {
        ...
        private  Dictionary<string,string> _ruleProperties=new Dictionary<string, string>();
        ...
        public void RuleProperties(Dictionary<string,string> properties)
        {
            _ruleProperties=properties;
        }
        ...
        public IRuleDefinition Build()
        {
            ...
            var ruleDefinition = Element.RuleDefinition(_name, _description, _priority, _repeatability, _tags, _properties, dependencies, lhs, filters, rhs, _ruleProperties);
