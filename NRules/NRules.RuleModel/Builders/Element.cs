...
namespace NRules.RuleModel.Builders
{
    ...
    public static class Element
    {
        ...
        /// <param name="rightHandSide">Rule's right-hand side group element.</param>
        /// <param name="ruleProperties">Rule's right-hand side group element.</param>

        /// <returns>Created rule definition.</returns>
        public static IRuleDefinition RuleDefinition(string name, string description, int priority,
            RuleRepeatability repeatability, IEnumerable<string> tags, IEnumerable<RuleProperty> properties,
            DependencyGroupElement dependencies, GroupElement leftHandSide, FilterGroupElement filters, ActionGroupElement rightHandSide,Dictionary<string,string> ruleProperties=null)
        {
            ...
            var ruleDefinition = new RuleDefinition(name, description, priority, repeatability, tags, properties, dependencies, leftHandSide, filters, rightHandSide,ruleProperties);
