...
namespace NRules.Fluent.Dsl
{
    ...
    public abstract class Rule
    {
        ...
        public IRuleDefinition GetDefinition()
        {
            return _definition.Value;
        }
        public Dictionary<string,string> RuleProperties
        {
            get;
            //{
            //    var ruleType = GetType();
            //    var metadata = new RuleMetadata(ruleType);
            //    foreach (var property in GetDefinition().RuleProperties)
            //    {
            //        if (metadata.RuleProperties.ContainsKey(property.Key))
            //        {
            //            metadata.RuleProperties[property.Key] = property.Value;
            //        }   
            //    }
            //    return metadata.RuleProperties;
            //}
        }
        ...
        private IRuleDefinition BuildDefinition()
        {
            ...
            _builder.RuleProperties(metadata.RuleProperties);
