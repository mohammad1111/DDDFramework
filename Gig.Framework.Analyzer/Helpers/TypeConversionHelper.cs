...
public class TypeConversionHelper
{
    ...
    private readonly NodeList<ITypeSymbol> _typeSymbols;
    ...
    public TypeConversionHelper(SemanticModel semanticModel)
    {
        ...
        _typeSymbols.Add(semanticModel, SpecialType.System_Boolean, SpecialType.System_String,
            SpecialType.System_Object, SpecialType.System_SByte,
        ...
        _typeSymbols.Add(semanticModel, SpecialType.System_Byte, SpecialType.System_String,
            SpecialType.System_Object, SpecialType.System_SByte,
        ...
        _typeSymbols.Add(semanticModel, SpecialType.System_Decimal, SpecialType.System_String,
            SpecialType.System_Object, SpecialType.System_SByte,
            SpecialType.System_Byte, SpecialType.System_Int16, SpecialType.System_UInt16, SpecialType.System_Int32,
            SpecialType.System_UInt32,
            SpecialType.System_Int64, SpecialType.System_UInt64);
        ...
        _typeSymbols.Add(semanticModel, SpecialType.System_Double, SpecialType.System_String,
            SpecialType.System_Object, SpecialType.System_SByte,
            SpecialType.System_Byte, SpecialType.System_Int16, SpecialType.System_UInt16, SpecialType.System_Int32,
            SpecialType.System_UInt32,
            SpecialType.System_Int64, SpecialType.System_UInt64);
        ...
        _typeSymbols.Add(semanticModel, SpecialType.System_Int32, SpecialType.System_String,
            SpecialType.System_Object, SpecialType.System_SByte,
        ...
        _typeSymbols.Add(semanticModel, SpecialType.System_Int64, SpecialType.System_String,
            SpecialType.System_Object, SpecialType.System_SByte,
            SpecialType.System_Byte, SpecialType.System_Int16, SpecialType.System_UInt16, SpecialType.System_Int32,
            SpecialType.System_UInt32,
        ...
        _typeSymbols.Add(semanticModel, SpecialType.System_Int16, SpecialType.System_String,
            SpecialType.System_Object, SpecialType.System_SByte,
        ...
        _typeSymbols.Add(semanticModel, SpecialType.System_DateTime, SpecialType.System_String,
            SpecialType.System_Object, SpecialType.System_Int32,
        ...
        _typeSymbols.Add(semanticModel, dateTimeOffsetSymbol, SpecialType.System_String, SpecialType.System_Object,
        ...
        _typeSymbols.Add(semanticModel, timeSpanSymbol, SpecialType.System_String, SpecialType.System_Object,
            SpecialType.System_Int32,
            SpecialType.System_Int64);

        _typeSymbols.Add(semanticModel, SpecialType.System_String, SpecialType.System_Enum);
        _typeSymbols.Add(semanticModel, SpecialType.System_Enum, SpecialType.System_String,
            SpecialType.System_Object, SpecialType.System_SByte,
            SpecialType.System_Byte, SpecialType.System_Int16, SpecialType.System_UInt16, SpecialType.System_Int32,
            SpecialType.System_UInt32,
            SpecialType.System_Int64, SpecialType.System_UInt64);
        ...
        while (true)
        {
            ...
            if (IsMessageData(symbol, out var messageDataType))
            {
                if (messageDataType.IsArray(out var arrayType) && arrayType.SpecialType == SpecialType.System_Byte)
                {
                    ...
                    {
                        if (sourceMessageDataType.IsArray(out var sourceDataArrayType) &&
                            sourceDataArrayType.SpecialType == SpecialType.System_Byte)
                            return true;
                    ...
                    if (sourceSymbol.IsArray(out var sourceArrayType) &&
                        sourceArrayType.SpecialType == SpecialType.System_Byte)
                        return true;
                ...
                if (messageDataType.SpecialType == SpecialType.System_String &&
                    sourceSymbol.SpecialType == SpecialType.System_String)
                    return true;

                var streamType = _semanticModel.Compilation.GetTypeByMetadataName(typeof(Stream).FullName);
                if (SymbolEqualityComparer.Default.Equals(messageDataType, streamType) &&
                    sourceSymbol.ImplementsType(streamType))
                    return true;
    ...
    private static bool IsTask(ITypeSymbol symbol, out ITypeSymbol result)
    {
    ...
    private static bool IsMessageData(ITypeSymbol symbol, out ITypeSymbol result)
    {
...
{
    public static void Add(this NodeList<ITypeSymbol> table, SemanticModel semanticModel, ITypeSymbol symbol,
        params SpecialType[] types)
    {
        var typeSymbols = types.Select(type => semanticModel.Compilation.GetSpecialType(type)).Cast<ITypeSymbol>()
            .ToArray();

        table.Add(symbol, typeSymbols);
    }

    public static void Add(this NodeList<ITypeSymbol> table, SemanticModel semanticModel, SpecialType specialType,
        params SpecialType[] types)
    {
